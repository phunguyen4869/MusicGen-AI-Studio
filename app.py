...
from tts_generation import render_text_to_speech_tab
from image_generation import render_text_to_image_tab
...
with tab4:
    render_text_to_image_tab(headers)

# --- TAB 5: TEXT TO SPEECH ---
with tab5:
    render_text_to_speech_tab(headers)
